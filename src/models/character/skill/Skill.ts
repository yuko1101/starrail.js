...
export class Skill {
    ...
    constructor(id: number, client: StarRail, skillIndexToUse = 0) {
        ...
        const json = new JsonReader(excelJsonOptions, this._skillsData[skillIndexToUse]);
        ...
        this.skillTypeText = new TextAssets(json.getAsNumberOrBigint("SkillTypeDesc", "Hash"), this.client);

        this.effectType = json.getAsString("SkillEffect") as EffectType;
        this.effectTypeText = new TextAssets(json.getAsNumberOrBigint("SkillTag", "Hash"), this.client);
